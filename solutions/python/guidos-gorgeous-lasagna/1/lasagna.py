...
def preparation_time_in_minutes(number_of_layers):
    ...
    :return: int - total minutes to prepare the lasagna layers
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    Function that takes the number of layers added to the lasagna and the actual
    minutes the lasagna has been in the oven as arguments and returns how many minutes
    you have been cooking, including preparation time.
    """
